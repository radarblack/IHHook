...
local this={
	...
	keyBindMenuToggleKey="F4",--tex: starting key that opens the in-game key-bindings menu (add more keys->scripts from there). Only used until you remap it once from the menu itself, after which mod/radarKeys/radar_keybinds.conf takes over.
}--this
return this
